...
app.post("/api/create-checkout-session", async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: "https://frontend-nu-nine-24.vercel.app/payment-success.html?session_id={CHECKOUT_SESSION_ID}",
            cancel_url: "https://frontend-nu-nine-24.vercel.app/payment-cancel.html",
        });
